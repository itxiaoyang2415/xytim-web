  ...
  <div class="app-container home">
    ...
    <el-row :gutter="20" style="margin-bottom: 20px">
      ...
      <el-col :span="4">
        <el-card class="statistics-card">
          <div class="statistics-item">
            <div class="statistics-icon" style="background-color: #F56C6C;">
              <el-icon size="24">
                <Calendar />
              </el-icon>
            </div>
      ...
      <el-col :span="4">
        <el-card class="statistics-card">
          <div class="statistics-item">
            <div class="statistics-icon" style="background-color: #8B5CF6;">
              <el-icon size="24">
                <TrendCharts />
              </el-icon>
            </div>
...
import { User, ChatDotRound, Timer, Calendar, Clock, TrendCharts, DataAnalysis, UserFilled, Grid } from '@element-plus/icons-vue';
