  ...
  <div class="p-2">
    ...
    <el-card shadow="never">
      <el-table v-loading="loading" :data="groupMessageList">
        <el-table-column label="群id" align="center" prop="id"> </el-table-column>
        <el-table-column label="群名" align="center" prop="groupName"> </el-table-column>
        ...
        <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
          <template #default="scope">
            <el-button link type="primary" @click="handleDetail(scope.row)"
              v-hasPermi="['im:groupMessage:query']">详情</el-button>
          </template>
        </el-table-column>
      </el-table>
