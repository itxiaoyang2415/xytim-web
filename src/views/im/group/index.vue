  ...
  <div class="p-2">
      ...
      <div v-show="showSearch" class="mb-[10px]">
        <el-card shadow="hover">
          <el-form ref="queryFormRef" :model="queryParams" :inline="true">
             <el-form-item label="群id" prop="name">
              <el-input v-model="queryParams.id" placeholder="请输入群id" clearable @keyup.enter="handleQuery" />
            </el-form-item>
    ...
    <el-card shadow="never">
      <el-table v-loading="loading" :data="groupList" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="是否开启禁言" align="center" prop="isAllMuted">
          <template #default="scope">
            <dict-tag :options="im_bool" :value="scope.row.isAllMuted" />
          </template>
        </el-table-column>
    ...
    <el-dialog :title="dialog.title" v-model="dialog.visible" width="800px" append-to-body>
      <el-form ref="groupFormRef" :model="form" label-width="100px" disabled>
        ...
        <el-form-item label="是否开启禁言" prop="isAllMuted">
          <dict-tag :options="im_bool" :value="form.isAllMuted" />
        </el-form-item>
